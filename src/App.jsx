...
function Navbar() {
  return (
    <div className="flex sticky top-0 justify-center py-1 filter backdrop-blur-sm w-full">
      ...
      <div className="mx-[9px] drop-shadow-xl rounded-3xl bg-teal-200 m-2">
    ...
    <>
      ...
      {active && (
        <ul
          ...
          className={`absolute p-1 bg-teal-200 rounded-3xl top-[65px] w-[200px] left-[56%] ${anim}`}
        >
          <Approved />
          <ul>
            <li
...
function Item() {
  return (
    <div className="transition duration-200 ease-in-out inline-block shadow-xl m-2 rounded-[30px] bg-white hover:shadow-2xl hover:shadow-gray-600 active:shadow-sm">
      <img
